...
namespace FluentlyWindsor.AspNetCore
{
	public static class AspNetCoreExtensions
	{
		...
		public static T GetRequestService<T>(this IApplicationBuilder builder) where T : class
		{
			...
			return ServiceProviderServiceExtensions.GetService<T>(GetRequestServiceProvider(builder));
		}
		...
		public static T GetRequiredRequestService<T>(this IApplicationBuilder builder) where T : class
		{
			...
			return ServiceProviderServiceExtensions.GetRequiredService<T>(GetRequestServiceProvider(builder));
		}
